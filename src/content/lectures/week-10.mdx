...
This is the hardest lecture in the course, and it is also the one that has to
be here.

Most of the semester treats waiting as a cost measured in minutes and general
annoyance, which is fine for almost everything you will meet. There is a region
of the state space, though, where that stops being true.
